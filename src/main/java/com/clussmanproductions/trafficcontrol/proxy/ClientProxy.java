...
//		ProgressManager.pop(progressBar);
	...
	public static void bakeModels(ModelBakeEvent e)
	{
		...
		for(String direction : new String[] { "ne", "nw", "se", "sw" })
		{
			for(EnumState flashState : EnumState.values())
			{
				for(int i = 0; i <= 16; i++)
				{
					...
					bakeModel(e, new ModelResourceLocation(ModTrafficControl.MODID + ":ped_crossing_lamps_" + direction + "_lamp", "rotation=" + i + ",state=" + flashState.getName()));
				}
			}
		}
		...
		bakeModel(e, new ModelResourceLocation(ModTrafficControl.MODID + ":vertical_wig_wag_arm_mount", "normal"));
		...
		bakeModel(e, new ModelResourceLocation(ModTrafficControl.MODID + ":wig_wag_arm_mount", "normal"));
		bakeModel(e, new ModelResourceLocation(ModTrafficControl.MODID + ":wig_wag_arm", "normal"));
		bakeModel(e, new ModelResourceLocation(ModTrafficControl.MODID + ":wig_wag_arm", "lamp=off"));
		bakeModel(e, new ModelResourceLocation(ModTrafficControl.MODID + ":wig_wag_arm", "lamp=on"));
		bakeModel(e, new ModelResourceLocation(ModTrafficControl.MODID + ":lower_wig_wag_arm", "normal"));
		bakeModel(e, new ModelResourceLocation(ModTrafficControl.MODID + ":lower_wig_wag_arm", "lamp=off"));
		bakeModel(e, new ModelResourceLocation(ModTrafficControl.MODID + ":lower_wig_wag_arm", "lamp=on"));
